...
mod tests {
    ...
    #[test]
    fn encode_calldata_creates_correct_abi_encoded_data() {
    ...
    #[test]
    fn check_if_malleable_returns_error_when_s_exceeds_upper_bound() {
    ...
    #[test]
    fn check_if_malleable_succeeds_with_s_below_upper_bound() {
