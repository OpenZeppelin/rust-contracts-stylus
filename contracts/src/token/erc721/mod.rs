...
mod tests {
    ...
    #[motsu::test]
    fn balance_of_reverts_when_owner_is_zero(contract: Erc721) {
    ...
    #[motsu::test]
    fn balance_of_returns_zero_for_new_address(contract: Erc721) {
    ...
    #[motsu::test]
    fn owner_of_reverts_when_token_nonexistent(contract: Erc721) {
        let err = contract
            .owner_of(TOKEN_ID)
    ...
    #[motsu::test]
    fn _mint_succeeds_for_valid_recipient(contract: Erc721) {
    ...
    #[motsu::test]
    fn _mint_reverts_when_token_already_exists(contract: Erc721) {
        let alice = msg::sender();
        contract
    ...
    #[motsu::test]
    fn _mint_reverts_when_receiver_invalid(contract: Erc721) {
    ...
    #[motsu::test]
    fn _safe_mint_creates_token_successfully(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn _safe_mint_reverts_when_token_already_exists(contract: Erc721) {
        let alice = msg::sender();
        contract
            ._mint(alice, TOKEN_ID)
            .expect("should mint the token a first time");
    ...
    #[motsu::test]
    fn _safe_mint_reverts_when_receiver_invalid(contract: Erc721) {
        let invalid_receiver = Address::ZERO;
    ...
    #[motsu::test]
    fn transfer_from_moves_token_successfully(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn transfer_from_succeeds_with_token_approval(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn transfer_from_moves_token_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
    ...
    #[motsu::test]
    fn transfer_from_reverts_when_receiver_invalid(contract: Erc721) {
        let alice = msg::sender();
        let invalid_receiver = Address::ZERO;
    ...
    #[motsu::test]
    fn transfer_from_reverts_when_sender_is_not_owner(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn transfer_from_reverts_when_approval_insufficient(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
        let err = contract
            .transfer_from(BOB, alice, TOKEN_ID)
    ...
    #[motsu::test]
    fn transfer_from_reverts_when_token_nonexistent(contract: Erc721) {
        let alice = msg::sender();
        let err = contract
            .transfer_from(alice, BOB, TOKEN_ID)
    ...
    #[motsu::test]
    fn safe_transfer_from_moves_token_successfully(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token to Alice");
    ...
    #[motsu::test]
    fn safe_transfer_from_succeeds_with_token_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
        contract._token_approvals.setter(TOKEN_ID).set(alice);
        contract
    ...
    #[motsu::test]
    fn safe_transfer_from_moves_token_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
    ...
    #[motsu::test]
    fn safe_transfer_from_reverts_when_receiver_invalid(contract: Erc721) {
        let alice = msg::sender();
        let invalid_receiver = Address::ZERO;
    ...
    #[motsu::test]
    fn safe_transfer_from_reverts_when_owner_incorrect(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn safe_transfer_from_reverts_when_approval_insufficient(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
        let err = contract
            .safe_transfer_from(BOB, alice, TOKEN_ID)
    ...
    #[motsu::test]
    fn safe_transfer_from_reverts_when_token_nonexistent(contract: Erc721) {
        let alice = msg::sender();
        let err = contract
            .safe_transfer_from(alice, BOB, TOKEN_ID)
            .expect_err("should not transfer a non-existent token");
    ...
    #[motsu::test]
    fn safe_transfer_from_success_with_data(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token to Alice");
    ...
    #[motsu::test]
    fn safe_transfer_from_success_with_data_and_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
        contract._token_approvals.setter(TOKEN_ID).set(alice);
        contract
    ...
    #[motsu::test]
    fn safe_transfer_from_success_with_data_and_approval_for_all(
        contract: Erc721,
    ) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
    ...
    #[motsu::test]
    fn safe_transfer_from_with_data_reverts_when_approval_insufficient(
        contract: Erc721,
    ) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
    ...
    #[motsu::test]
    fn safe_transfer_from_with_data_reverts_when_token_nonexistent(
        contract: Erc721,
    ) {
        let alice = msg::sender();
        let err = contract
    ...
    #[motsu::test]
    fn approve_sets_token_approval(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn approve_reverts_when_token_nonexistent(contract: Erc721) {
        let err = contract
            .approve(BOB, TOKEN_ID)
    ...
    #[motsu::test]
    fn approve_reverts_when_approver_invalid(contract: Erc721) {
    ...
    #[motsu::test]
    fn set_approval_for_all_grants_operator_permission(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn set_approval_for_all_reverts_when_operator_is_zero(contract: Erc721) {
    ...
    #[motsu::test]
    fn get_approved_reverts_when_token_nonexistent(contract: Erc721) {
        let err = contract
    ...
    #[motsu::test]
    fn owner_of_success(contract: Erc721) {
        contract._mint(BOB, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn owner_of_read_success_with_nonexistent_token(contract: Erc721) {
        let owner = contract._owner_of(TOKEN_ID);
        assert_eq!(Address::ZERO, owner);
    }

    #[motsu::test]
    fn get_approved_success_with_nonexistent_token(contract: Erc721) {
        let approved = contract._get_approved(TOKEN_ID);
        assert_eq!(Address::ZERO, approved);
    }

    #[motsu::test]
    fn get_approved_success_with_no_approval(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn get_approved_returns_approved_address(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn get_approved_success_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn is_authorized_success_with_nonexistent_token(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn _is_authorized_allows_token_owner(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn is_authorized_success_with_no_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn is_authorized_success_with_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
        contract
            .approve(BOB, TOKEN_ID)
    ...
    #[motsu::test]
    fn is_authorized_success_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
        contract
            .set_approval_for_all(BOB, true)
    ...
    #[motsu::test]
    fn check_authorized_reverts_when_token_nonexistent(contract: Erc721) {
        let alice = msg::sender();
        let err = contract
    ...
    #[motsu::test]
    fn _check_authorized_succeeds_with_valid_permission(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn check_authorized_reverts_when_not_approved(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn check_authorized_success_with_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
        contract
            .approve(BOB, TOKEN_ID)
    ...
    #[motsu::test]
    fn check_authorized_success_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
        contract
            .set_approval_for_all(BOB, true)
    ...
    #[motsu::test]
    fn _burn_removes_token_successfully(contract: Erc721) {
        let alice = msg::sender();
        let one = uint!(1_U256);
    ...
    #[motsu::test]
    fn _burn_reverts_when_token_does_not_exist(contract: Erc721) {
        let err = contract
            ._burn(TOKEN_ID)
            .expect_err("should return Error::NonexistentToken");
    ...
    #[motsu::test]
    fn _transfer_moves_token_successfully(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token to Alice");
        contract
    ...
    #[motsu::test]
    fn transfer_success_with_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
        contract._token_approvals.setter(TOKEN_ID).set(alice);
        contract
    ...
    #[motsu::test]
    fn transfer_success_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
    ...
    #[motsu::test]
    fn _transfer_reverts_when_receiver_is_zero(contract: Erc721) {
        let alice = msg::sender();
        let invalid_receiver = Address::ZERO;
    ...
    #[motsu::test]
    fn _transfer_reverts_when_sender_is_not_owner(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn _transfer_reverts_when_token_nonexistent(contract: Erc721) {
        let alice = msg::sender();
        let err = contract
            ._transfer(alice, BOB, TOKEN_ID)
            .expect_err("should not transfer a non-existent token");
    ...
    #[motsu::test]
    fn _safe_transfer_completes_successfully(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token to Alice");
    ...
    #[motsu::test]
    fn safe_transfer_success_with_approval(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
        contract._token_approvals.setter(TOKEN_ID).set(alice);
        contract
    ...
    #[motsu::test]
    fn safe_transfer_success_with_approval_for_all(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint token to Bob");
    ...
    #[motsu::test]
    fn _safe_transfer_reverts_when_receiver_invalid(contract: Erc721) {
        let alice = msg::sender();
        let invalid_receiver = Address::ZERO;
    ...
    #[motsu::test]
    fn _safe_transfer_reverts_when_sender_is_not_owner(contract: Erc721) {
        let alice = msg::sender();
    ...
    #[motsu::test]
    fn _safe_transfer_reverts_when_token_nonexistent(contract: Erc721) {
        let alice = msg::sender();
        let err = contract
            ._safe_transfer(alice, BOB, TOKEN_ID, &vec![0, 1, 2, 3].into())
            .expect_err("should not transfer a non-existent token");
    ...
    #[motsu::test]
    fn _approve_internal_sets_approval_correctly(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(alice, TOKEN_ID).expect("should mint a token");
        contract
    ...
    #[motsu::test]
    fn approve_internal_reverts_when_token_nonexistent(contract: Erc721) {
        let err = contract
    ...
    #[motsu::test]
    fn approve_internal_reverts_when_approver_invalid(contract: Erc721) {
        let alice = msg::sender();
        contract._mint(BOB, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn approve_for_all_internal_success(contract: Erc721) {
        let alice = msg::sender();
        contract._operator_approvals.setter(alice).setter(BOB).set(false);
    ...
    #[motsu::test]
    fn approve_for_all_internal_reverts_when_operator_invalid(
        contract: Erc721,
    ) {
        let invalid_operator = Address::ZERO;
    ...
    #[motsu::test]
    fn _require_owned_returns_owner_successfully(contract: Erc721) {
        contract._mint(BOB, TOKEN_ID).expect("should mint a token");
    ...
    #[motsu::test]
    fn require_owned_reverts_when_token_nonexistent(contract: Erc721) {
        let err = contract
            ._require_owned(TOKEN_ID)
            .expect_err("should return Error::NonexistentToken");
    ...
    #[motsu::test]
    fn interface_id_returns_correct_standard_id() {
