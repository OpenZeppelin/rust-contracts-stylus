...
impl FpParams<LIMBS_256> for VestaParam {
    ...
    const MODULUS: BigInt<LIMBS_256> = from_num!("28948022309329048855892746252171976963363056481941647379679742748393362948097");
}
...
impl FpParams<LIMBS_64> for BabyBearParam {
    ...
    const MODULUS: BigInt<LIMBS_64> = from_num!("2013265921");
}
...
impl FpParams<LIMBS_256> for BLS12Param {
    ...
    const MODULUS: BigInt<LIMBS_256> = from_num!("52435875175126190479447740508185965837690552500527637822603658699938581184513");
}
...
impl FpParams<LIMBS_256> for BN256Param {
    ...
    const MODULUS: BigInt<LIMBS_256> = from_num!("21888242871839275222246405745257275088548364400416034343698204186575808495617");
}
...
impl FpParams<LIMBS_64> for GoldiLocksParam {
    ...
    const MODULUS: BigInt<LIMBS_64> = from_num!("18446744069414584321");
}
...
impl FpParams<LIMBS_256> for PallasParam {
    ...
    const MODULUS: BigInt<LIMBS_256> = from_num!("28948022309329048855892746252171976963363056481941560715954676764349967630337");
}
