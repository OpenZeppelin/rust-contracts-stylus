...
For more advanced proxy patterns, see the examples in the repository:
* `examples/proxy/` - Basic proxy implementation
* `examples/erc1967/` - ERC-1967 standardized proxy
* `examples/beacon-proxy/` - Beacon proxy pattern 