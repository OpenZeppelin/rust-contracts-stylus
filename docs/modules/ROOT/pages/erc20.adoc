 ...
 * xref:erc20-wrapper.adoc[ERC-20 Wrapper]: Extension of the ERC-20 token contract to support token wrapping (standardized as https://eips.ethereum.org/EIPS/eip-3156[`EIP-3156`]).
