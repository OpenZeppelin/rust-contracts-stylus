...
https://docs.rs/openzeppelin-crypto/0.1.0/openzeppelin_crypto/merkle/struct.Verifier.html[`MerkleProof`] provides:

* https://docs.rs/openzeppelin-crypto/0.1.0/openzeppelin_crypto/merkle/struct.Verifier.html#method.verify[`verify`] - can prove that some value is part of a https://en.wikipedia.org/wiki/Merkle_tree[Merkle tree].

* https://docs.rs/openzeppelin-crypto/0.1.0/openzeppelin_crypto/merkle/struct.Verifier.html#method.verify_multi_proof[`verify_multi_proof`] - can prove multiple values are part of a Merkle tree.
...
We also provide an adapter https://docs.rs/openzeppelin-crypto/0.1.0/openzeppelin_crypto/hash/index.html[`hash`] module to use your own hashers in conjunction with them that resembles Rust's standard library's API.
